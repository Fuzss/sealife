...
public class ModBiomeTagProvider extends AbstractTagProvider<Biome> {
    ...
    public void addTags(HolderLookup.Provider registries) {
        ...
        this.tag(ModRegistry.SPAWNS_ANGLERFISH_BIOME_TAG)
                .addKey(Biomes.DEEP_FROZEN_OCEAN, Biomes.DEEP_COLD_OCEAN, Biomes.DEEP_OCEAN);

        // BASS - Temperate freshwater fish, found in various water bodies
        this.tag(ModRegistry.SPAWNS_BASS_BIOME_TAG)
                .addKey(Biomes.RIVER, Biomes.MEADOW)
        ...
        this.tag(ModRegistry.SPAWNS_BLUE_TANG_BIOME_TAG)
                .addKey(Biomes.WARM_OCEAN, Biomes.LUKEWARM_OCEAN, Biomes.DEEP_LUKEWARM_OCEAN);
        ...
        this.tag(ModRegistry.SPAWNS_CHUB_BIOME_TAG).addKey(Biomes.RIVER, Biomes.MEADOW).addTag(BiomeTags.IS_FOREST);
        ...
        this.tag(ModRegistry.SPAWNS_KOI_BIOME_TAG)
                .addKey(Biomes.RIVER, Biomes.MEADOW, Biomes.CHERRY_GROVE)
                .addTag(ModRegistry.IS_PLAINS_BIOME_TAG)
                .addTag(BiomeTags.IS_FOREST);

        // LAMPREY - Parasitic fish found in both fresh and saltwater
        this.tag(ModRegistry.SPAWNS_LAMPREY_BIOME_TAG)
                .addKey(Biomes.RIVER, Biomes.OCEAN, Biomes.DEEP_OCEAN, Biomes.COLD_OCEAN, Biomes.DEEP_COLD_OCEAN);
        ...
        this.tag(ModRegistry.SPAWNS_NORTHERN_PIKE_BIOME_TAG)
                .addKey(Biomes.FROZEN_RIVER, Biomes.GROVE)
        ...
        this.tag(ModRegistry.SPAWNS_PUPFISH_BIOME_TAG)
                .addKey(Biomes.RIVER, Biomes.DESERT, Biomes.SAVANNA, Biomes.SAVANNA_PLATEAU);

        // SARDINE - Saltwater fish that form large schools
        this.tag(ModRegistry.SPAWNS_SARDINE_BIOME_TAG)
                .addKey(Biomes.OCEAN, Biomes.DEEP_OCEAN, Biomes.COLD_OCEAN, Biomes.DEEP_COLD_OCEAN);
        ...
        this.tag(ModRegistry.SPAWNS_SILVER_STRIPE_BLAASOP_BIOME_TAG)
                .addKey(Biomes.COLD_OCEAN, Biomes.DEEP_COLD_OCEAN, Biomes.FROZEN_OCEAN, Biomes.DEEP_FROZEN_OCEAN);
        ...
        this.tag(ModRegistry.SPAWNS_WALLEYE_BIOME_TAG).addKey(Biomes.RIVER, Biomes.MEADOW).addTag(BiomeTags.IS_TAIGA);
    }
}
