...
public class MantaRayModel extends FishModel<LivingEntityRenderState> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partDefinition1.addOrReplaceChild("right_filter",
                CubeListBuilder.create().texOffs(0, 32).addBox(-4.0F, -2.0F, -6.0F, 2.0F, 7.0F, 2.0F),
                PartPose.offsetAndRotation(1.0F, 2.75F, -6.05F, -0.9599F, 0.0F, -0.1309F));

        partDefinition1.addOrReplaceChild("left_filter",
                CubeListBuilder.create().texOffs(8, 32).addBox(0.0F, -2.0F, -6.0F, 2.0F, 7.0F, 2.0F),
                PartPose.offsetAndRotation(1.0F, 2.75F, -6.05F, -0.9599F, 0.0F, 0.1309F));
