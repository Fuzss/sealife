...
public class ModBlocks {
    public static final DeferredBlock<Block> FISH_TRAP = ModRegistry.REGISTRIES.registerBlock("fish_trap",
            FishTrapBlock::new);
    public static final DeferredBlock<Block> HATCHERY = ModRegistry.REGISTRIES.registerBlock("hatchery",
            HatcheryBlock::new);
    public static final DeferredBlock<Block> RECYCLER = ModRegistry.REGISTRIES.registerBlock("recycler",
            RecyclerBlock::new);

    @SubscribeEvent
    public static void registerHandlers(RegisterCapabilitiesEvent event) {
        event.registerBlockEntity(Capabilities.ItemHandler.BLOCK,
                PiscaryBlockEntities.FISH_TRAP.get(),
                InventoryBlockEntity.getItemProvider());
        event.registerBlockEntity(Capabilities.ItemHandler.BLOCK,
                PiscaryBlockEntities.RECYCLER.get(),
                InventoryBlockEntity.getItemProvider());
    }
