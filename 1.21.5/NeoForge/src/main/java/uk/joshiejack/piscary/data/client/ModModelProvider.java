...
public class ModModelProvider extends AbstractModelProvider {
    ...
    public void addItemModels(ItemModelGenerators itemModelGenerators) {
        ...
        itemModelGenerators.generateFlatItem(ModItems.FISH_FINGERS_FOOD.value(), ModelTemplates.FLAT_ITEM);
        itemModelGenerators.generateFlatItem(ModItems.SASHIMI_FOOD.value(), ModelTemplates.FLAT_ITEM);
        itemModelGenerators.generateFlatItem(ModItems.FISH_STEW_FOOD.value(), ModelTemplates.FLAT_ITEM);
